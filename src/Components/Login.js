    ...
    <div class="w-3/4 p-4 max-w-sm bg-white mr-0 rounded-lg border border-gray-200 shadow-lg shadow-gray-700 sm:p-6 lg:p-8 font-Poppins">
        <div class="space-y-6" action="#">
            ...
            <div class="flex items-start">
                ...
                <a href="/" class=" text-md text-blue-700 hover:underline dark:text-blue-500">Doesn't have an account? </a>
            </div>
            <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" onClick={clickfun}>Login to your account</button>
        </div>
    </div>
