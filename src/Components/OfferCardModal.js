...
const OfferCardModal = ({close}) => {
    return (
        <>


            <div id="authentication-modal" tabindex="-1" className="h-screen bg-gray-500 bg-opacity-50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0  z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center flex" aria-modal="true" role="dialog">
                <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                    ...
                    <div className="relative bg-[#FFF5F9] rounded-lg shadow-lg">
                        ...
                        <div className="py-6 px-6 lg:px-8 text-colortxt">
                            <h3 className="mb-4 text-xl font-medium  ">Edit Offer</h3>
                            <form className="space-y-6" action="#">
                                ...
                                <div>
                                    <input type="file" className="bg-white  outline-none border border-[#FACFE0] focus:ring-4 focus:ring-[#FACFE0]  placeholder:text-[#D27095] text-sm rounded-lg block w-full p-2.5" required="" />
                                </div>
                                <div>
                                   <textarea className='outline-none border border-[#FACFE0] focus:ring-4 focus:ring-[#FACFE0]  placeholder:text-[#D27095] placeholder:m-5 text-sm rounded-lg block w-full p-2.5"' placeholder='Descipton ' rows='6' cols='46'></textarea>
                                </div>
